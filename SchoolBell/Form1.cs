...
namespace SchoolBell
{
    public partial class MainForm : Form
    {
        ...
        private volatile int _hourBegin11 = 12;
        private volatile int _hourBegin12 = 12;
        private volatile int _hourBegin13 = 12;
        private volatile int _hourBegin14 = 12;
        private volatile int _hourBegin15 = 12;
        private volatile int _hourBegin16 = 12;
        private volatile int _hourBegin17 = 12;
        private volatile int _hourBegin21 = 12;
        private volatile int _hourBegin22 = 12;
        private volatile int _hourBegin23 = 12;
        private volatile int _hourBegin24 = 12;
        private volatile int _hourBegin25 = 12;
        private volatile int _hourBegin26 = 12;
        private volatile int _minutBegin11 = 12;
        private volatile int _minutBegin12 = 12;
        private volatile int _minutBegin13 = 12;
        private volatile int _minutBegin14 = 12;
        private volatile int _minutBegin15 = 12;
        private volatile int _minutBegin16 = 12;
        private volatile int _minutBegin17 = 12;
        private volatile int _minutBegin21 = 12;
        private volatile int _minutBegin22 = 12;
        private volatile int _minutBegin23 = 12;
        private volatile int _minutBegin24 = 12;
        private volatile int _minutBegin25 = 12;
        private volatile int _minutBegin26 = 12;
        private volatile int _hourFinish11 = 12;
        private volatile int _hourFinish12 = 12;
        private volatile int _hourFinish13 = 12;
        private volatile int _hourFinish14 = 12;
        private volatile int _hourFinish15 = 12;
        private volatile int _hourFinish16 = 12;
        private volatile int _hourFinish17 = 12;
        private volatile int _hourFinish21 = 12;
        private volatile int _hourFinish22 = 12;
        private volatile int _hourFinish23 = 12;
        private volatile int _hourFinish24 = 12;
        private volatile int _hourFinish25 = 12;
        private volatile int _hourFinish26 = 12;
        private volatile int _minutFinish11 = 15;
        private volatile int _minutFinish12 = 15;
        private volatile int _minutFinish13 = 15;
        private volatile int _minutFinish14 = 15;
        private volatile int _minutFinish15 = 15;
        private volatile int _minutFinish16 = 15;
        private volatile int _minutFinish17 = 15;
        private volatile int _minutFinish21 = 15;
        private volatile int _minutFinish22 = 15;
        private volatile int _minutFinish23 = 15;
        private volatile int _minutFinish24 = 15;
        private volatile int _minutFinish25 = 15;
        private volatile int _minutFinish26 = 15;
        private volatile int _sekundInterval = 10;
        private bool _hour11 = true;
        private bool _hour12 = true;
        private bool _hour13 = true;
        private bool _hour14 = true;
        private bool _hour15 = true;
        private bool _hour16 = true;
        private bool _hour17 = true;
        private bool _hour21 = true;
        private bool _hour22 = true;
        private bool _hour23 = true;
        private bool _hour24 = true;
        private bool _hour25 = true;
        private bool _hour26 = true;
...
// ReSharper restore FunctionNeverReturns
        ...
        private void ReadConfig()
        {
            ...
            try
            {
                ...
                //{
                sr = new StreamReader(Directory.GetCurrentDirectory() + @"\config.ini");
                #region
                /////////////////////////////////////
                ...
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour11 = Boolean.Parse(line[1]);
                checkBoxRun1_1.Checked = _hour11;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour12 = Boolean.Parse(line[1]);
                checkBoxRun1_2.Checked = _hour12;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour13 = Boolean.Parse(line[1]);
                checkBoxRun1_3.Checked = _hour13;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour14 = Boolean.Parse(line[1]);
                checkBoxRun1_4.Checked = _hour14;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour15 = Boolean.Parse(line[1]);
                checkBoxRun1_5.Checked = _hour15;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour16 = Boolean.Parse(line[1]);
                checkBoxRun1_6.Checked = _hour16;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour17 = Boolean.Parse(line[1]);
                checkBoxRun1_7.Checked = _hour17;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour21 = Boolean.Parse(line[1]);
                checkBoxRun2_1.Checked = _hour21;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour22 = Boolean.Parse(line[1]);
                checkBoxRun2_2.Checked = _hour22;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour23 = Boolean.Parse(line[1]);
                checkBoxRun2_3.Checked = _hour23;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour24 = Boolean.Parse(line[1]);
                checkBoxRun2_4.Checked = _hour24;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour25 = Boolean.Parse(line[1]);
                checkBoxRun2_5.Checked = _hour25;
                /////////////////////////////////////
                line = sr.ReadLine().Trim().Split('=');
                _hour26 = Boolean.Parse(line[1]);
                checkBoxRun2_6.Checked = _hour26;
                /////////////////////////////////////
                sr.Close();
        ...
        private void WriteConfig()
        {
            ...
            using (StreamWriter w = new StreamWriter(Directory.GetCurrentDirectory() + @"\config.ini"))
            {
                ...
                w.WriteLine(String.Format("_hour11={0}", _hour11));
                w.WriteLine(String.Format("_hour12={0}", _hour12));
                w.WriteLine(String.Format("_hour13={0}", _hour13));
                w.WriteLine(String.Format("_hour14={0}", _hour14));
                w.WriteLine(String.Format("_hour15={0}", _hour15));
                w.WriteLine(String.Format("_hour16={0}", _hour16));
                w.WriteLine(String.Format("_hour17={0}", _hour17));
                w.WriteLine(String.Format("_hour21={0}", _hour21));
                w.WriteLine(String.Format("_hour22={0}", _hour22));
                w.WriteLine(String.Format("_hour23={0}", _hour23));
                w.WriteLine(String.Format("_hour24={0}", _hour24));
                w.WriteLine(String.Format("_hour25={0}", _hour25));
                w.WriteLine(String.Format("_hour26={0}", _hour26));
        ...
        private void checkBoxRun1_1_CheckedChanged(object sender, EventArgs e)
        {
            _hour11 = checkBoxRun1_1.Checked;
        }

        private void checkBoxRun1_2_CheckedChanged(object sender, EventArgs e)
        {
            _hour12 = checkBoxRun1_2.Checked;
        }

        private void checkBoxRun1_3_CheckedChanged(object sender, EventArgs e)
        {
            _hour13 = checkBoxRun1_3.Checked;
        }

        private void checkBoxRun1_4_CheckedChanged(object sender, EventArgs e)
        {
            _hour14 = checkBoxRun1_4.Checked;
        }

        private void checkBoxRun1_5_CheckedChanged(object sender, EventArgs e)
        {
            _hour15 = checkBoxRun1_5.Checked;
        }

        private void checkBoxRun1_6_CheckedChanged(object sender, EventArgs e)
        {
            _hour17 = checkBoxRun1_7.Checked;
        }

        private void checkBoxRun1_7_CheckedChanged(object sender, EventArgs e)
        {
            _hour17 = checkBoxRun1_7.Checked;
        }

        private void checkBoxRun2_1_CheckedChanged(object sender, EventArgs e)
        {
            _hour21 = checkBoxRun2_1.Checked;
        }

        private void checkBoxRun2_2_CheckedChanged(object sender, EventArgs e)
        {
            _hour22 = checkBoxRun2_2.Checked;
        }

        private void checkBoxRun2_3_CheckedChanged(object sender, EventArgs e)
        {
            _hour23 = checkBoxRun2_3.Checked;
        }

        private void checkBoxRun2_4_CheckedChanged(object sender, EventArgs e)
        {
            _hour24 = checkBoxRun2_4.Checked;
        }

        private void checkBoxRun2_5_CheckedChanged(object sender, EventArgs e)
        {
            _hour25 = checkBoxRun2_5.Checked;
        }

        private void checkBoxRun2_6_CheckedChanged(object sender, EventArgs e)
        {
            _hour26 = checkBoxRun2_6.Checked;
        }
